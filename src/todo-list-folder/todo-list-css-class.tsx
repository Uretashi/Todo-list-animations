                    ...
                    <div className="todo-main-div">
                        <div className="todo-main-object">
                            {this.state.todoList.map((todoName: string, index: number) => {
                                return (
                                    <div data-testid={todoName.toLowerCase().replace(/\s/g, '_') + '_div'} id="divcontainer" key={todoName} className="w-100 mt-1 mb-1 rounded h4 todoelement todo-object">
                                        ...
                                        <button data-testid={index + '_delete'} className="bouton btn btn-dark bouton " onClick={(event) => this.deleteTodoElement(event, index)}>X</button>
                                    </div>
                                )
                            })}
                        </div>
